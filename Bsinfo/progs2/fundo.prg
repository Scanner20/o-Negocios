...
IF !EMPTY(VERSION(2))
	SET DEFA TO f:\AplVfp\Fundo
ENDIF
*!*	Activar los Paths para sus formularios personales.... (xUsuario)
SET PATH TO f:\AplVfp\Fundo\Formularios , ; 
            f:\AplVfp\Fundo\Programas , ;
            f:\AplVfp\Fundo\Reportes , ;
            f:\AplVfp\Fundo\Menus , ;
            f:\AplVfp\Fundo\Clases , ;
            f:\AplVfp\Fundo\Data , ;
			f:\AplVfp\ClasesGenerales\Programacion01\Programacion\Clases , ;
			f:\AplVfp\ClasesGenerales\Programacion01\Programacion\Formularios ,;
			f:\AplVfp\ClasesGenerales\Programacion01\Programacion\Reportes, ; 
			f:\AplVfp\ClasesGenerales\Programacion01\Programacion\Programas			
...
PUBLIC goEntorno , goConexion , GoCfgAlm, GoCfgCpi
...
goCfgAlm	= CREATEOBJECT("Almplibf")
goCfgCpi	= CREATEOBJECT("Cpiplibf")
...
*!*	_SCREEN.PICTURE	= "\AplVfp02\bmps\fsc_e_1.bmp"
*!*	_SCREEN.PICTURE	= "\AplVfp02\bmps\main3a_v.bmp"
*!*	_SCREEN.PICTURE	= "\AplVfp02\bmps\valencia_1.bmp"
_SCREEN.PICTURE	= "\AplVfp\fundo\bmps\reservorio.bmp"
...
*
Public _Mes, _Ano, XsNroMes,GlCorrU_I,GlContra,K_ESC
*
GsCodCia	='001'
GsNomcia	='FUNDO SANTA CECILIA S.A.'
GsCodSed	='001'
GsNomSed	= 'Santa Rosita'
GsSubAlm	='010'
GsNomSub	='Sta.Rosita - Insecticidas'
GlCorrU_I   = .F.
GlContra  	= .F.
K_ESC = 27
GdFecha = DATETIME()
...
*
OPEN DATABASE admin
OPEN DATABASE cia001
OPEN DATABASE per2002
