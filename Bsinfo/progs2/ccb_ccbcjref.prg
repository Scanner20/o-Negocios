...
*  Nombre    : CcbCjRef.PRG                                              *
*  Autor     : VETT                                                      *
*  Objeto    : Canje por Letras en base a la REFINANCIACION              *
*  Par metros:                                                           *
*  Creaci¢n     : 24/06/94                                               *
*  Actualizaci¢n:                                                        *
**************************************************************************
...
DO fondo WITH 'Canjes en base a refinanciación',Goentorno.user.login,GsNomCia,GsFecha
...
*1    Canje #      : 1234567890 Refinanciacion:1234567890    Fecha : 99/99/99
*2    Cod.Cliente  :
*3    Observaciones:
...
CLEAR
Titulo = "** CANJE POR LETRAS EN BASE A LA REFINANCIACION **"
@  0,(80-LEN(Titulo))/2 SAY Titulo COLOR SCHEME 7
@  1,5  SAY "Canje #      :            Refinanciacion:              Fecha :" &&font 'Courier New', 10
@  2,5  SAY "Cod.Cliente  :                                              "
...
@ 14,5  SAY "        ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿ "
@ 15,5  SAY "        ³ No.Letra   Emision   Vencto.     Imp.Letra.      ³ "
@ 16,5  SAY "        ÃÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´ "
@ 17,5  SAY "        ³                                                  ³ "
@ 18,5  SAY "        ³                                                  ³ "
@ 19,5  SAY "        ³                                                  ³ "
@ 20,5  SAY "        ³                                                  ³ "
@ 21,5  SAY "        ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ "
@ 22,5  SAY "------------------------> Importe Total :                    "

@  6,20 SAY " Tpo.Doc.   Nro.Documento          Importe  " COLOR SCHEME 7
@ 15,15 SAY " No.Letra   Emision   Vencto.     Imp.Letra.    " COLOR SCHEME 7
...
m.NroDoc = PADR(PADL(ALLTRIM(STR(TDOC->NroDoc)),7,'0'),LEN(TASG->NroDoc))
*
SELE TASG
m.crear  = .T.
UltTecla = 0
   ...
   DO CASE
      CASE i = 1
         ...
         IF FlgEst = [E]   && Ya asignado
            GsMsgErr = [ Refinanciación ya Genero Letras ]
            DO lib_merr WITH 99
            SET ORDER TO TASG01
            SET FILTER TO CodRef=m.CodRef
            LOOP
      ...
      CASE i = 5
         ...
         @ 13,41 GET m.LetIni PICT "9999999"
         READ
         UltTecla = LASTKEY()
      CASE i = 6
...
m.NroLet = m.LetIni
FOR i = 1 TO GiTotLet
   AsNroDoc(i) = PADR(PADL(ALLTRIM(STR(m.NroLet)),7,'0'),LEN(GDOC->NroDoc))
   m.NroLet = m.NroLet + 1
...
@ NumLin,26 SAY AdFchDoc(NumEle)	PICT "@RD DD/MM/AAAA"
@ NumLin,38 SAY AdFchVto(NumEle)	PICT "@RD DD/MM/AAAA"
@ NumLin,50 SAY AfImpTot(NumEle)    PICT "999,999,999.99"
...
@ NumLin,14 GET LsNroDoc PICT "@!" VALID _lsnrodoc()
READ
UltTecla = LASTKEY()
IF LASTKEY() # 27
