...
SET SYSMENU TO DEFA
	IF INLIST(SYS(5),'F','E','D','C')
		...
		DEFINE WINDOW desktop2 FROM 1,20 TO 40,77  TITLE 'Las Bebitas' FLOAT GROW CLOSE MINIMIZE FILL FILE LOCFILE(SYS(5)+'\APLVFP\grafgen\jpeg\Jane\jane_joan.JPG')
		ACTIVATE WINDOW desktop2
...
SET PATH TO .\Forms , ; 
            ...
            .\Menus , ;
            .\vcxs , ;
            o:\o-negocios\Sumaqao , ;
            o:\o-negocios\Sumaqao\Data , ;
			..\classgen\vcxs , ;
			..\classgen\Forms ,;
			..\classgen\Reports ,;
			..\classgen\PROGS ,;
...
*!*	Goentorno.User.Login= 'Pfernandez'
*!*	GoEntorno.USER.GroupName		= 'Ventas'
*!*	GsUsuario = 'Pfernandez'
=BuildAccessCursor()
xAcceso = .T.
************************
