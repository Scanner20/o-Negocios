...
SET PATH TO .\Forms , ; 
            ...
            .\Menus , ;
            .\vcxs , ;
			H:\o-Negocios\demo1\o-negocios\Aromas, ;
			H:\o-Negocios\demo1\o-negocios\Aromas\Data, ;
			..\classgen\vcxs , ;
			..\classgen\Forms ,;
			..\classgen\Reports ,;
			..\classgen\PROGS ,;
...
*!*	GoEntorno.USER.GroupName		= 'COSTOS'
...
*!*	GoEntorno.USER.GroupName		= 'COSTOS'
*!*	GsUsuario = 'Rruiz'
*!*	goentorno.user.FormFami	 = "[A02FL],[A02AT],[A02SA],[A02SD],[A02AC],[A02AF]"
=BuildAccessCursor()
