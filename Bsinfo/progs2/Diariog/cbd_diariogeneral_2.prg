...
STORE '' to XsCodCta,XsClfAux,XsCodAux,XsCodPrv,XsNomPrv,XsRefPrv,XsIniAux,XsCodRef,XsCodRef ,xsglodoc,XsProyecto
STORE {} to XdFchVto,XdFchPed,XdFchDoc,XdFchDtr
STORE '' to xsnivadi,XsCodDoc,XsNroDoc,XsNroRef ,XSCODFIN,XcTpoMov
...
STORE '' TO XsCodCco,XsAn1Cta,XsCC1Cta,XsChkCta,XsTipOri1,XsNumOri1
	...
	CASE CTAS.TIP_AFE_RV='A'
		...
		** Grabando la segunda cuenta autom tica **
		...
		IF RMOV.ChkCta==LsChkCta .AND. &RegVal
			LlCrearDeta  = .F.
		ENDIF
		** Grabando la primera cuenta automática **
		IF LlCrearDeta 
			XiNroItm = XiNroItm + 1
		ELSE
			XiNroItm = NroItm
...
*!*				@09,22 get oSn.Vctori  pict '@E' valid (oSn.Vctori<>ctod(space(08)) .and. oSn.Vctori<=oSn2.fchdoc)
			read
