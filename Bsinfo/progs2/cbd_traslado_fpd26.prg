PARAMETERS _RutaOrig,_CiaOrig,_AnoOrig,_CiaDes,_AnoDes,_MesIni,_MesFin,_FchIni,_FchFin

IF DTOS(GdFecha)>'200511'
...
LsRutaCiaAno = ADDBS(LsRutaCia+'C'+_AnoOrig)
LsDBCia		 = _CiaDes+'!' 	
LsDBCiaAno	 = 'P'+_CIADES+_AnoDes+'!'

DO interface WITH LsDbCia+'CBDMTABL',LsRutaCia+'cbdmtabl'
DO interface WITH 'admin!admmtcmb',_RutaOrig+'admmtcmb'
DO interface WITH LsDBCia+'CBDMAUXI',LsRutaCia+'CBDMAUXI.DBF'
DO interface WITH LsDBCiaAno+'CBDTOPER',LsRutaCiaAno+'CBDTOPER.DBF'
DO interface WITH LsDBCiaAno+'CBDMCTAS',LsRutaCiaAno+'CBDMCTAS.DBF'
DO interface WITH LsDBCiaAno+'CBDVMOVM',LsRutaCiaAno+'CBDVMOVM.DBF'
