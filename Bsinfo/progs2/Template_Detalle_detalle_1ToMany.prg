**************************************************
*-- Class:        mto_act_maq (k:\aplvfp\classgen\vcxs\fpmtto.vcx)
*-- ParentClass:  base_form (k:\aplvfp\classgen\vcxs\fpadmvrs.vcx)
*-- BaseClass:    form
*-- Time Stamp:   10/17/05 01:43:03 AM
*
#INCLUDE "k:\aplvfp\bsinfo\progs\const.h"
*
DEFINE CLASS mto_act_maq AS base_form
	...
	ADD OBJECT mto_act_maq.pgfctaaux.page1.cmdadicionar1 AS cmdnuevo WITH ;
		Top = 359, ;
		Left = 11, ;
		Enabled = .F., ;
		TabIndex = 2, ;
	...
	ADD OBJECT mto_act_maq.pgfctaaux.page1.cmdmodificar1 AS cmdmodificar WITH ;
		Top = 359, ;
		Left = 59, ;
		Enabled = .F., ;
		TabIndex = 3, ;
	...
	ADD OBJECT mto_act_maq.pgfctaaux.page1.cmdeliminar1 AS cmdeliminar WITH ;
		Top = 359, ;
		Left = 107, ;
		Enabled = .F., ;
		TabIndex = 4, ;
	...
	ADD OBJECT mto_act_maq.pgfctaaux.page1.cmdimprimir1 AS cmdimprimir WITH ;
		Top = 359, ;
		Left = 531, ;
		Enabled = .F., ;
		TabIndex = 5, ;
	...
	ADD OBJECT mto_act_maq.pgfctaaux.page1.cmdsalir1 AS cmdsalir WITH ;
		Top = 359, ;
		Left = 589, ;
		TabIndex = 6, ;
		Name = "Cmdsalir1"
	...
	ADD OBJECT mto_act_maq.pgfctaaux.page1.grdctaaux AS base_grid WITH ;
		ColumnCount = 9, ;
		HeaderHeight = 30, ;
		Height = 332, ;
		Left = 8, ;
	...
	ADD OBJECT mto_act_maq.pgfctaaux.page1.grdctaaux.column1.header1 AS header WITH ;
		Caption = "Código", ;
		WordWrap = .T., ;
		Name = "Header1"


	ADD OBJECT mto_act_maq.pgfctaaux.page1.grdctaaux.column1.text1 AS textbox WITH ;
		BorderStyle = 0, ;
		Margin = 0, ;
		ReadOnly = .T., ;
		ForeColor = RGB(0,0,0), ;
	...
	ADD OBJECT mto_act_maq.pgfctaaux.page1.grdctaaux.column2.header1 AS header WITH ;
		Caption = "Ubicación", ;
		WordWrap = .T., ;
		Name = "Header1"


	ADD OBJECT mto_act_maq.pgfctaaux.page1.grdctaaux.column2.text1 AS textbox WITH ;
		BorderStyle = 0, ;
		Margin = 0, ;
		ReadOnly = .T., ;
		ForeColor = RGB(0,0,0), ;
	...
	ADD OBJECT mto_act_maq.pgfctaaux.page1.grdctaaux.column3.header1 AS header WITH ;
		Caption = "Descripcion Máquina", ;
		WordWrap = .T., ;
		Name = "Header1"


	ADD OBJECT mto_act_maq.pgfctaaux.page1.grdctaaux.column3.text1 AS textbox WITH ;
		BorderStyle = 0, ;
		Margin = 0, ;
		ReadOnly = .T., ;
		ForeColor = RGB(0,0,0), ;
	...
	ADD OBJECT mto_act_maq.pgfctaaux.page1.grdctaaux.column4.header1 AS header WITH ;
		Caption = "Responsable", ;
		WordWrap = .T., ;
		Name = "Header1"


	ADD OBJECT mto_act_maq.pgfctaaux.page1.grdctaaux.column4.text1 AS textbox WITH ;
		BorderStyle = 0, ;
		Margin = 0, ;
		ReadOnly = .T., ;
		ForeColor = RGB(0,0,0), ;
	...
	ADD OBJECT mto_act_maq.pgfctaaux.page1.grdctaaux.column5.header1 AS header WITH ;
		Caption = "Marca", ;
		WordWrap = .T., ;
		Name = "Header1"


	ADD OBJECT mto_act_maq.pgfctaaux.page1.grdctaaux.column5.text1 AS textbox WITH ;
		BorderStyle = 0, ;
		Margin = 0, ;
		ReadOnly = .T., ;
		ForeColor = RGB(0,0,0), ;
	...
	ADD OBJECT mto_act_maq.pgfctaaux.page1.grdctaaux.column6.header1 AS header WITH ;
		Caption = "Modelo", ;
		WordWrap = .T., ;
		Name = "Header1"


	ADD OBJECT mto_act_maq.pgfctaaux.page1.grdctaaux.column6.text1 AS textbox WITH ;
		BorderStyle = 0, ;
		Margin = 0, ;
		ReadOnly = .T., ;
		ForeColor = RGB(0,0,0), ;
	...
	ADD OBJECT mto_act_maq.pgfctaaux.page1.grdctaaux.column7.header1 AS header WITH ;
		Caption = "Numero de Serie", ;
		WordWrap = .T., ;
		Name = "Header1"


	ADD OBJECT mto_act_maq.pgfctaaux.page1.grdctaaux.column7.text1 AS textbox WITH ;
		BorderStyle = 0, ;
		Margin = 0, ;
		ForeColor = RGB(0,0,0), ;
		BackColor = RGB(255,255,255), ;
	...
	ADD OBJECT mto_act_maq.pgfctaaux.page1.grdctaaux.column8.header1 AS header WITH ;
		Caption = "Contometro", ;
		WordWrap = .T., ;
		Name = "Header1"


	ADD OBJECT mto_act_maq.pgfctaaux.page1.grdctaaux.column8.text1 AS textbox WITH ;
		BorderStyle = 0, ;
		Margin = 0, ;
		ForeColor = RGB(0,0,0), ;
		BackColor = RGB(255,255,255), ;
	...
	ADD OBJECT mto_act_maq.pgfctaaux.page1.grdctaaux.column9.header1 AS header WITH ;
		Caption = "Dias de avance", ;
		WordWrap = .T., ;
		Name = "Header1"


	ADD OBJECT mto_act_maq.pgfctaaux.page1.grdctaaux.column9.text1 AS textbox WITH ;
		BorderStyle = 0, ;
		Margin = 0, ;
		ForeColor = RGB(0,0,0), ;
		BackColor = RGB(255,255,255), ;
	...
	ADD OBJECT mto_act_maq.pgfctaaux.page2.edtcomentar AS base_editbox WITH ;
		Enabled = .F., ;
		Height = 48, ;
		Left = 187, ;
		MaxLength = 254, ;
	...
	ADD OBJECT mto_act_maq.pgfctaaux.page2.cmdaceptar2 AS cmdaceptar WITH ;
		Top = 359, ;
		Left = 628, ;
		Enabled = .F., ;
		TabIndex = 17, ;
	...
	ADD OBJECT mto_act_maq.pgfctaaux.page2.cmdcancelar2 AS cmdcancelar WITH ;
		Top = 359, ;
		Left = 694, ;
		Enabled = .F., ;
		TabIndex = 18, ;
	...
	ADD OBJECT mto_act_maq.pgfctaaux.page2.lblnombre AS base_label WITH ;
		Caption = "Descripción", ;
		Left = 112, ;
		Top = 41, ;
		TabIndex = 21, ;
	...
	ADD OBJECT mto_act_maq.pgfctaaux.page2.txtdesmaq AS base_textbox WITH ;
		Enabled = .F., ;
		Format = "K", ;
		Height = 24, ;
		Left = 187, ;
	...
	ADD OBJECT mto_act_maq.pgfctaaux.page2.lblprom_avan1 AS base_label WITH ;
	...
	ADD OBJECT mto_act_maq.pgfctaaux.page2.lblcodmaq AS base_label WITH ;
		Caption = "Código", ;
		Left = 138, ;
		Top = 16, ;
		TabIndex = 23, ;
	...
	ADD OBJECT mto_act_maq.pgfctaaux.page2.lblconto_actu AS base_label WITH ;
		FontSize = 9, ;
	...
	ADD OBJECT mto_act_maq.pgfctaaux.page2.cmdhelpcodmat AS base_cmdhelp WITH ;
		Top = 12, ;
		Left = 293, ;
		Height = 26, ;
		Width = 24, ;
	...
	ADD OBJECT mto_act_maq.pgfctaaux.page2.lblsubsistema AS base_label WITH ;
		Caption = "Subsistema", ;
		Left = 111, ;
		Top = 325, ;
		Visible = .F., ;
	...
	ADD OBJECT mto_act_maq.pgfctaaux.page2.cbosubsistema AS base_cbohelp WITH ;
		FontBold = .F., ;
		ColumnCount = 2, ;
		Enabled = .F., ;
		Height = 24, ;
	...
	ADD OBJECT mto_act_maq.pgfctaaux.page2.lblubicacion AS base_label WITH ;
		Caption = "Ubicación", ;
		Left = 123, ;
		Top = 149, ;
		TabIndex = 20, ;
	...
	ADD OBJECT mto_act_maq.pgfctaaux.page2.txtubic_actua AS base_textbox WITH ;
		Enabled = .F., ;
		Format = "K", ;
		Height = 24, ;
		Left = 379, ;
	...
	ADD OBJECT mto_act_maq.pgfctaaux.page2.lblrespon AS base_label WITH ;
		WordWrap = .T., ;
	...
	ADD OBJECT mto_act_maq.pgfctaaux.page2.txtrespon AS base_textbox WITH ;
		Enabled = .F., ;
		Format = "K", ;
		Height = 24, ;
		Left = 379, ;
	...
	ADD OBJECT mto_act_maq.pgfctaaux.page2.lblprom_avan2 AS base_label WITH ;
	...
	ADD OBJECT mto_act_maq.pgfctaaux.page2.lblprom_avan3 AS base_label WITH ;
	...
	ADD OBJECT mto_act_maq.pgfctaaux.page2.cntunid_avanc AS base_textbox_cmdhelp WITH ;
		Top = 350, ;
		Left = 82, ;
		Width = 396, ;
		Height = 25, ;
	...
	ADD OBJECT mto_act_maq.pgfctaaux.page2.spnconto_actu AS base_spinner_numero WITH ;
		Enabled = .F., ;
		Height = 24, ;
		InputMask = "99,999", ;
		Left = 395, ;
	...
	ADD OBJECT mto_act_maq.pgfctaaux.page2.spndias_avanc AS base_spinner_numero WITH ;
		Enabled = .F., ;
		InputMask = "999", ;
		Left = 395, ;
		TabIndex = 15, ;
	...
	ADD OBJECT mto_act_maq.pgfctaaux.page2.lbldias_avanc AS base_label WITH ;
		Caption = "Dias de avance", ;
		Height = 17, ;
		Left = 298, ;
		Top = 387, ;
	...
	ADD OBJECT mto_act_maq.pgfctaaux.page2.lblsistema AS base_label WITH ;
		Caption = "Sistema", ;
		Left = 133, ;
		Top = 296, ;
		Visible = .F., ;
	...
	ADD OBJECT mto_act_maq.pgfctaaux.page2.cbosistema AS base_cbohelp WITH ;
		FontBold = .F., ;
		ColumnCount = 2, ;
		Enabled = .F., ;
		Height = 24, ;
	...
	ADD OBJECT mto_act_maq.pgfctaaux.page2.spnprm_ava_horas AS base_spinner_numero WITH ;
		Enabled = .F., ;
		Height = 24, ;
		InputMask = "99,999", ;
		Left = 189, ;
	...
	ADD OBJECT mto_act_maq.pgfctaaux.page2.spnprm_ava_minutos AS base_spinner_numero WITH ;
		Enabled = .F., ;
		Height = 24, ;
		InputMask = "99,999", ;
		Left = 189, ;
	...
	ADD OBJECT mto_act_maq.pgfctaaux.page2.spnprm_ava_segundos AS base_spinner_numero WITH ;
		Enabled = .F., ;
		Height = 24, ;
		InputMask = "99,999", ;
		Left = 189, ;
	...
	ADD OBJECT mto_act_maq.pgfctaaux.page2.lblcomentarios AS base_label WITH ;
		FontSize = 9, ;
		Caption = "Comentarios", ;
		Height = 17, ;
		Left = 107, ;
	...
	ADD OBJECT mto_act_maq.pgfctaaux.page2.txtcodmaq AS base_textbox WITH ;
		Enabled = .F., ;
		Format = "L", ;
		Height = 23, ;
	...
	ADD OBJECT mto_act_maq.pgfctaaux.page2.txtmarca AS base_textbox WITH ;
		Enabled = .F., ;
		Format = "K", ;
		Height = 24, ;
		Left = 187, ;
	...
	ADD OBJECT mto_act_maq.pgfctaaux.page2.lblmarca AS base_label WITH ;
		Caption = "Marca", ;
		Left = 144, ;
		Top = 70, ;
		TabIndex = 26, ;
	...
	ADD OBJECT mto_act_maq.pgfctaaux.page2.txtmodelo AS base_textbox WITH ;
		Enabled = .F., ;
		Format = "K", ;
		Height = 24, ;
		Left = 188, ;
	...
	ADD OBJECT mto_act_maq.pgfctaaux.page2.lblmodelo AS base_label WITH ;
		Caption = "Modelo", ;
		Left = 137, ;
		Top = 98, ;
		TabIndex = 28, ;
	...
	ADD OBJECT mto_act_maq.pgfctaaux.page2.txtnoserie AS base_textbox WITH ;
		Enabled = .F., ;
		Format = "K", ;
		Height = 24, ;
		Left = 188, ;
	...
	ADD OBJECT mto_act_maq.pgfctaaux.page2.lblnroserie AS base_label WITH ;
		Caption = "Nro. Serie", ;
		Left = 123, ;
		Top = 124, ;
		TabIndex = 27, ;
	...
	ADD OBJECT mto_act_maq.pgfctaaux.page2.cboubicacion AS base_cbohelp WITH ;
		FontBold = .F., ;
		ColumnCount = 2, ;
		Enabled = .F., ;
		Height = 24, ;
	...
	ADD OBJECT mto_act_maq.pgfctaaux.page2.cboarea AS base_cbohelp WITH ;
		FontBold = .F., ;
		ColumnCount = 2, ;
		Enabled = .F., ;
		Height = 24, ;
	...
	ADD OBJECT mto_act_maq.pgfctaaux.page2.lblarea AS base_label WITH ;
		Caption = "Area", ;
		Left = 152, ;
		Top = 178, ;
		TabIndex = 20, ;
	...
	ADD OBJECT mto_act_maq.pgfctaaux.page2.cboespecialidad AS base_cbohelp WITH ;
		FontBold = .F., ;
		ColumnCount = 2, ;
		Enabled = .F., ;
		Height = 24, ;
	...
	ADD OBJECT mto_act_maq.pgfctaaux.page2.base_checkbox1 AS base_checkbox WITH ;
		Top = 291, ;
		Left = 7, ;
		Height = 24, ;
		Width = 96, ;
	...
	ADD OBJECT mto_act_maq.pgfctaaux.page3.cntdetalle_detalle_detalle1 AS cntdetalle_detalle_detalle WITH ;
		Top = 32, ;
		Left = 3, ;
		Width = 647, ;
		Height = 378, ;
		...
		LblDetalle4.Caption = "Especificaciones", ;
		...
		CtmSeccion4.caliascursor = ([c_Espec]), ;
		CtmSeccion4.cnombreentidad = ([MtoSpect]), ;
		CtmSeccion4.corderby = ([Cod_Carac]), ;
		CtmSeccion4.Name = "CtmSeccion4"


	ADD OBJECT mto_act_maq.pgfctaaux.page3.lblfecha AS base_label WITH ;
		Caption = "Código", ;
		Left = 15, ;
		Top = 10, ;
		TabIndex = 23, ;
	...
	ADD OBJECT mto_act_maq.pgfctaaux.page3.lblnombre AS base_label WITH ;
		Caption = "Descripción", ;
		Left = 167, ;
		Top = 10, ;
		TabIndex = 21, ;
	...
	ADD OBJECT mto_act_maq.pgfctaaux.page3.txtcodmaq AS base_textbox WITH ;
		Enabled = .F., ;
		Format = "L", ;
		Height = 23, ;
		InputMask = "XXXXXXXXXX", ;
	...
	ADD OBJECT mto_act_maq.pgfctaaux.page3.txtdesmaq AS base_textbox WITH ;
		Enabled = .F., ;
		Format = "K", ;
		Height = 24, ;
		Left = 240, ;
