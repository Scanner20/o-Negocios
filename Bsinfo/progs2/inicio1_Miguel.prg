...
DEFINE WINDOW desktop2 FROM 1,20 TO 20,40  TITLE 'Output' FLOAT GROW CLOSE MINIMIZE
...
SET CLASSLIB TO ADMNOVIS , ADMTBAR , ADMVRS , ADMGRAL ,DOSVR, O-N
CLOSE DATABASES ALL
...
goEntPub = CREATEOBJECT("DOSVR.Env")
