...
***** Cabecera
STORE "" TO XsNroAst,XdFchAst,XsNotAst,XiCodMon,XfTpoCmb,XsNroVou,XsCodDiv,XsCtaPre
********* Detalle
	...
	CASE EMPTY(TsAn1Cta) AND EMPTY(TsCC1Cta)  AND !(ctas.CodCta>='60' AND ctas.CodCta<='99' AND CTAS.TpoCta=3) AND !CTAS.TIP_AFE_RC='A'
		...
		** Verificamos su existencia **
		IF ! SEEK(GsClfCct+TsAn1Cta,"AUXI")
			GsMsgErr = "Cuenta Autom tica no existe. Actualización queda pendiente"
			=MESSAGEBOX(GsMsgErr,16,'Atención')
			RETURN 2
		ENDIF
