...
SET SYSMENU TO DEFA
	IF INLIST(SYS(5),'F','E','C')
		...
		DEFINE WINDOW desktop2 FROM 1,20 TO 40,77  TITLE 'Las Bebitas' FLOAT GROW CLOSE MINIMIZE FILL FILE LOCFILE(SYS(5)+'\dev\APLVFP\grafgen\jpeg\Jane\jane_joan_3.JPG')
		ACTIVATE WINDOW desktop2
...
SET PATH TO .\Forms , ; 
            ...
            .\Menus , ;
            .\vcxs , ;
         d:\o-negocios\Ferrechiang, ;
           d:\o-negocios\Ferrechiang\Data , ;
			..\classgen\vcxs , ;
			..\classgen\Forms ,;
			..\classgen\Reports ,;
			..\classgen\PROGS ,;
