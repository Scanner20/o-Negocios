...
SET SYSMENU TO DEFA
	IF INLIST(SYS(5),'F','E','D')
		...
		DEFINE WINDOW desktop2 FROM 1,20 TO 20,50  TITLE 'Output' FLOAT GROW CLOSE MINIMIZE FILL FILE LOCFILE(SYS(5)+'\dev_thinkpad\APLVFP\grafgen\jpeg\Jane\Jane_Set2006_1_4.JPG')
		ACTIVATE WINDOW desktop2

	ELSE
		CD SYS(5)+'\aplvfp\bsinfo\proys\'
		SET DEFA TO \AplVfp\bsinfo
		DEFINE WINDOW desktop2 FROM 1,20 TO 20,50  TITLE 'Output' FLOAT GROW CLOSE MINIMIZE FILL FILE LOCFILE(SYS(5)+'\aplvfp\grafgen\jpeg\Jane\Jane_Set2006_1_4.JPG')
		ACTIVATE WINDOW desktop2
