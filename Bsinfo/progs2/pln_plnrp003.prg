...
DO CASE
	CASE INLIST(SRepor,1,2)
		COPY TO (ArcTmp) FOR TpoVar$'1234567'
	CASE SRepor = 3
...
ENDIF
SELECT 0
USE (ArcTmp) ALIAS BPGO EXCLUSIVE
SELECT BPGO
	...
	*!*	Para Ingresos
	...
	DO WHILE TpoVar = '1'
		...
		ELSE
			XsValRef = ''
		ENDIF
		xTot01 = xTot01 + IIF(BPGO.FlgCal,XfValCal,0) && XfValCal
		n1 = n1 + 1
	...
	*!*	Para Descuentos
	...
	DO WHILE TpoVar = '2'
		...
		ELSE
			XsValRef = ''
		ENDIF
		xTot02 = xTot02 + IIF(BPGO.FlgCal,XfValCal,0) && XfValCal
		n2 = n2 + 1
