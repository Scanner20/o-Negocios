...
SET SYSMENU TO DEFA
	IF INLIST(SYS(5),'F','E','D','C')
		CD SYS(5)+'\dev\aplvfp\bsinfo\proys\'
		SET DEFA TO \dev\AplVfp\bsinfo
	***	DEFINE WINDOW desktop2 FROM 1,20 TO 20,50  TITLE 'Output' FLOAT GROW CLOSE MINIMIZE FILL FILE LOCFILE(SYS(5)+'\dev\APLVFP\grafgen\jpeg\Jane\Jane20060401005.jpg')
		DEFINE WINDOW desktop2 FROM 1,20 TO 20,50  TITLE 'Output' FLOAT GROW CLOSE MINIMIZE 
		ACTIVATE WINDOW desktop2
...
***************************
GoEntorno.USER.GroupName		= 'MASTER'
...
Public GsCodSed,GsNomSed,GsSubAlm,GsNomSub,GaLenCod,GaClfDiv,GsClfAtr
