...
#DEFINE PAPERSIZE_JPN_ENV               84                           && JPN Envelope Kaku #2 Rotated 
#DEFINE PAPERSIZE_JPN_ENV               85                           && JPN Envelope Kaku #3 Rotated 
#DEFINE PAPERSIZE_JPN_ENV               86                           && JPN Envelope Chou #3 Rotated 
#DEFINE PAPERSIZE_JPN_ENV               87                           && JPN Envelope Chou #4 Rotated 
...
#DEFINE PAPERSIZE_JPN_ENV               91                           && JPN Envelope You #4 
#DEFINE PAPERSIZE_JPN_ENV               92                           && JPN Envelope You #4 Rotated 
