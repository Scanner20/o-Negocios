...
ArcTem = PATHUSER+SYS(3)
SELE 0
CREATE TABLE (ARCTEM)  (CODPLN C(1)  ,;
                       CTACTS C(10) ,;
                       NROPER C(2)  ,;
                       CODPER C(6)  ,;
                       CODMOV C(4)  ,;
...
USE (ArcTem) ALIAS TEMP Exclu
IF !USED()
   CLOSE DATA
   RETURN
ENDIF
INDEX ON NROPER+CODMOV+CTACTS TAG TEMP01
INDEX ON TIPMOV+CODMOV        TAG TEMP02


ArcTmp = PATHUSER+SYS(3)
SELE 0
CREATE TABLE (ARCTMP)  (CODPLN C(1)  ,;
                       CTACTS C(10) ,;
                       NROPER C(2)  ,;
                       CODPER C(6)  ,;
                       CODMOV C(4)  ,;
...
RESTORE FROM H:\BASE\CIA001\C1997\CBDCONFG ADDITIVE
DO MOVApert
IF ! USED(1)
   CLOSE DATA
   RETURN
...
SELE 9
USE (ArcTem)   ORDER temp02   ALIAS Temp
IF !used(9)
    close data
    return
ENDIF
...
DO WHILE ! EOF() .AND. &RegVal .AND. EliItm = CHR(250)
   DO BORRLIN
   REPLACE VMOV->NroItm  WITH VMOV->NroItm-1
   SKIP
ENDDO
...
REPLACE CodMOV WITH "TD01"
REPLACE ValCAL WITH VALCAL("TD01")
...
REPLACE NROPER WITH XSNROPER
REPLACE CodPer WITH PERS->CodPer
REPLACE CodMOV WITH "TS01"
REPLACE ValCAL WITH VALCAL("TS01")
...
REPLACE NROPER WITH XSNROPER
REPLACE CodPer WITH PERS->CodPer
REPLACE CodMOV WITH "TS04"
REPLACE ValCAL WITH VALCAL("TS04")
ENDIF
**** SENATI ****
...
REPLACE NROPER WITH XSNROPER
REPLACE CodPer WITH PERS->CodPer
REPLACE CodMOV WITH "TS05"
REPLACE ValCAL WITH VALCAL("TS05")
ENDIF
...
REPLACE NROPER WITH XSNROPER
REPLACE CodPer WITH PERS->CodPer
REPLACE CodMOV WITH "TS06"
REPLACE ValCAL WITH VALCAL("TS06")
ENDIF
ENDIF
...
REPLACE NROPER WITH XSNROPER
REPLACE CodPer WITH PERS->CodPer
REPLACE CodMOV WITH "TE02"
REPLACE ValCAL WITH VALCAL("TE02")
...
REPLACE NROPER WITH XSNROPER
REPLACE CodPer WITH PERS->CodPer
REPLACE CodMOV WITH "TF01"
REPLACE VALCAL WITH VALCAL("TF01")+VALCAL("TF03")+VALCAL("TF04")+VALCAL("TF05")
...
REPLACE NROPER WITH XSNROPER
REPLACE CodPer WITH PERS->CodPer
REPLACE CodMOV WITH "TK12"
REPLACE VALCAL WITH VALCAL("TK12")
ENDIF
...
REPLACE NROPER WITH XSNROPER
REPLACE CodPer WITH PERS->CodPer
REPLACE CodMOV WITH "TZ04"
REPLACE VALCAL WITH VALCAL("TZ04")
...
REPLACE NROPER WITH XSNROPER
REPLACE CodPer WITH PERS->CodPer
REPLACE CodMOV WITH "TO22"
REPLACE VALCAL WITH VALCAL("TO22")
...
REPLACE NROPER WITH XSNROPER
REPLACE CodPer WITH PERS->CodPer
REPLACE CodMOV WITH "TZ02"
REPLACE VALCAL WITH VALCAL("TZ02")

APPEND BLANK
REPLACE CODPLN WITH XSCODPLN
REPLACE NROPER WITH XSNROPER
REPLACE CodPer WITH PERS->CodPer
REPLACE CodMOV WITH "TZ03"
REPLACE VALCAL WITH VALCAL("TZ03")
...
REPLACE NROPER WITH XSNROPER
REPLACE CodPer WITH PERS->CodPer
REPLACE CodMOV WITH "TM01"
REPLACE VALCAL WITH VALCAL("TM01")
ENDIF
...
REPLACE NROPER WITH XSNROPER
REPLACE CodPer WITH PERS->CodPer
REPLACE CodMOV WITH "TM02"
REPLACE VALCAL WITH VALCAL("TM02")
ENDIF
...
REPLACE NROPER WITH XSNROPER
REPLACE CodPer WITH PERS->CodPer
REPLACE CodMOV WITH "TE05"
REPLACE VALCAL WITH VALCAL("TE05")
ENDIF
...
REPLACE NROPER WITH XSNROPER
REPLACE CodPer WITH PERS->CodPer
REPLACE CodMOV WITH "TO21"
REPLACE VALCAL WITH VALCAL("TO21")
ENDIF
endif
...
REPLACE NROPER WITH XSNROPER
REPLACE CodPer WITH PERS->CodPer
REPLACE CodMOV WITH "TJ01"
REPLACE VALCAL WITH VALCAL("TJ01")
ENDIF
...
REPLACE NROPER WITH XSNROPER
REPLACE CodPer WITH PERS->CodPer
REPLACE CodMOV WITH "TO11"
REPLACE VALCAL WITH VALCAL("TO11")
ENDIF
*ndif
...
REPLACE NROPER WITH XSNROPER
REPLACE CodPer WITH PERS->CodPer
REPLACE CodMOV WITH "TO03"
REPLACE VALCAL WITH VALCAL("TO01")+VALCAL("TO02")+VALCAL("TO03")+VALCAL("TO22")+VALCAL("TO80")
endif



IF XSCODPLN="1"
IF VALCAL("TO01")+VALCAL("TO02")+VALCAL("TO03")>0
APPEND BLANK
REPLACE CODPLN WITH XSCODPLN
REPLACE NROPER WITH XSNROPER
REPLACE CodPer WITH PERS->CodPer
REPLACE CodMOV WITH "TO03"
REPLACE VALCAL WITH VALCAL("TO01")+VALCAL("TO02")+VALCAL("TO03")
ENDIF
ENDIF
RETURN
...
SELE CCTO
SET ORDER TO CCTO02
set filter TO INLIST(CODMOV,[TD01],[TS])
GO TOP
...
SELE CCTO
SET ORDER TO CCTO01
set filter TO INLIST(CODMOV,[TK12],[TZ],[TE],[TJ],[TS],[TF],[TM],[TO])
GO TOP
