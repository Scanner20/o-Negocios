...
SET SYSMENU TO DEFA
	IF INLIST(SYS(5),'F','E','D')
		...
		DEFINE WINDOW desktop2 FROM 0+5,0+60 TO 22.5+5,64.875+60  TITLE 'Las Bebitas' FLOAT GROW CLOSE MINIMIZE FILL FILE LOCFILE(SYS(5)+'\APLVFP\grafgen\jpeg\Jane\jane_joan_2.JPG')
		ACTIVATE WINDOW desktop2
	ELSE
		CD SYS(5)+'\aplvfp\bsinfo\proys\'
		SET DEFA TO \AplVfp\bsinfo
