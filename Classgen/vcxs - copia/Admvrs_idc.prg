**************************************************
*-- Class Library:  k:\aplvfp\classgen\vcxs\admvrs_idc.vcx
**************************************************


**************************************************
*-- Class:        base_cbohelp (k:\aplvfp\classgen\vcxs\admvrs_idc.vcx)
*-- ParentClass:  base_combobox (k:\aplvfp\classgen\vcxs\admvrs.vcx)
*-- BaseClass:    combobox
*-- Time Stamp:   07/05/10 10:01:08 AM
*
...
**************************************************
*-- Class:        base_cbohelp_gtablas (k:\aplvfp\classgen\vcxs\admvrs_idc.vcx)
...
**************************************************
*-- Class:        base_cbohelp_serie (k:\aplvfp\classgen\vcxs\admvrs_idc.vcx)
*-- ParentClass:  base_cbohelp (k:\aplvfp\classgen\vcxs\admvrs.vcx)
*-- BaseClass:    combobox
...
**************************************************
*-- Class:        base_checkbox (k:\aplvfp\classgen\vcxs\admvrs_idc.vcx)
...
**************************************************
*-- Class:        base_checkbox_multiselect (k:\aplvfp\classgen\vcxs\admvrs_idc.vcx)
...
**************************************************
*-- Class:        base_checkbox_serie (k:\aplvfp\classgen\vcxs\admvrs_idc.vcx)
*-- ParentClass:  checkbox
*-- BaseClass:    checkbox
...
**************************************************
*-- Class:        base_cmdhelp (k:\aplvfp\classgen\vcxs\admvrs_idc.vcx)
*-- ParentClass:  base_command (k:\aplvfp\classgen\vcxs\admvrs.vcx)
*-- BaseClass:    commandbutton
*-- Time Stamp:   11/25/10 09:43:11 PM
*
...
**************************************************
*-- Class:        base_combobox (k:\aplvfp\classgen\vcxs\admvrs_idc.vcx)
...
**************************************************
*-- Class:        base_command (k:\aplvfp\classgen\vcxs\admvrs_idc.vcx)
...
**************************************************
*-- Class:        base_container (k:\aplvfp\classgen\vcxs\admvrs_idc.vcx)
*-- ParentClass:  container
*-- BaseClass:    container
*-- Time Stamp:   08/31/09 05:42:12 PM
*
...
**************************************************
*-- Class:        base_control (k:\aplvfp\classgen\vcxs\admvrs_idc.vcx)
*-- ParentClass:  control
*-- BaseClass:    control
...
**************************************************
*-- Class:        base_control_labelshadow (k:\aplvfp\classgen\vcxs\admvrs_idc.vcx)
...
**************************************************
*-- Class:        base_criterios_seleccion (k:\aplvfp\classgen\vcxs\admvrs_idc.vcx)
...
**************************************************
*-- Class:        base_editbox (k:\aplvfp\classgen\vcxs\admvrs_idc.vcx)
*-- ParentClass:  editbox
*-- BaseClass:    editbox
...
**************************************************
*-- Class:        base_form (k:\aplvfp\classgen\vcxs\admvrs_idc.vcx)
*-- ParentClass:  form
*-- BaseClass:    form
*-- Time Stamp:   08/17/10 07:06:04 AM
*
...
DEFINE CLASS base_form AS form
	...
	*-- Muestra el error segun tabla de errores
	PROCEDURE mensajeerr
		...
		ELSE
			RETURN MESSAGEBOX('Se ha producido un error no identificado',0+16,'Atención!!/Warning!!')
		ENDIF
	...
	*-- Cargar objeto contenedor dentro de un pageframe
	...
	PROCEDURE Init
		...
		*!*			this.nomobjcntpage = this.nomobjcntpage
		...
		ENDIF
		** VETT  17/08/2010 06:52 AM : Objeto manipulador de datos 
...
**************************************************
*-- Class:        base_form_transac (k:\aplvfp\classgen\vcxs\admvrs_idc.vcx)
*-- ParentClass:  base_form (k:\aplvfp\classgen\vcxs\admvrs.vcx)
*-- BaseClass:    form
*-- Time Stamp:   12/01/10 12:19:13 PM
			...
			**
			IF THISFORM.xReturn <> 'I'   		&& Modificar o Eliminar
				...
				WITH thisform.objcntcab 
					...
					IF INLIST(.CboCodDoc.Value,'PEDI','PROF','COTI')
...
**************************************************
*-- Class:        base_grid (k:\aplvfp\classgen\vcxs\admvrs_idc.vcx)
*-- ParentClass:  grid
*-- BaseClass:    grid
*-- Time Stamp:   09/03/10 10:36:02 PM
*
#INCLUDE "k:\aplvfp\bsinfo\progs\const.h"
*
DEFINE CLASS base_grid AS grid
	...
	*-- Almacena el resultado de sumar el valor del campo contenido en cFieldToSum
	ncolumnsum = 0
	*-- Utilizar el ForeColor y BackColor hecho en tiempo de diseño, cuando es .F. mantiene los valores por defecto
...
**************************************************
*-- Class:        base_grid_atributos (k:\aplvfp\classgen\vcxs\admvrs_idc.vcx)
...
**************************************************
*-- Class:        base_gridheader (k:\aplvfp\classgen\vcxs\admvrs_idc.vcx)
*-- ParentClass:  container
*-- BaseClass:    container
...
**************************************************
*-- Class:        base_img (k:\aplvfp\classgen\vcxs\admvrs_idc.vcx)
*-- ParentClass:  image
*-- BaseClass:    image
...
**************************************************
*-- Class:        base_img_desarrollo_version (k:\aplvfp\classgen\vcxs\admvrs_idc.vcx)
...
**************************************************
*-- Class:        base_label (k:\aplvfp\classgen\vcxs\admvrs_idc.vcx)
*-- ParentClass:  label
*-- BaseClass:    label
...
**************************************************
*-- Class:        base_label_shape (k:\aplvfp\classgen\vcxs\admvrs_idc.vcx)
...
**************************************************
*-- Class:        base_listbox (k:\aplvfp\classgen\vcxs\admvrs_idc.vcx)
*-- ParentClass:  listbox
*-- BaseClass:    listbox
...
**************************************************
*-- Class:        base_optiongroup (k:\aplvfp\classgen\vcxs\admvrs_idc.vcx)
...
**************************************************
*-- Class:        base_pageframe (k:\aplvfp\classgen\vcxs\admvrs_idc.vcx)
...
**************************************************
*-- Class:        base_rango_codigos (k:\aplvfp\classgen\vcxs\admvrs_idc.vcx)
*-- ParentClass:  base_container (k:\aplvfp\classgen\vcxs\admvrs.vcx)
*-- BaseClass:    container
...
**************************************************
*-- Class:        base_shape (k:\aplvfp\classgen\vcxs\admvrs_idc.vcx)
*-- ParentClass:  shape
*-- BaseClass:    shape
...
**************************************************
*-- Class:        base_spinner_moneda (k:\aplvfp\classgen\vcxs\admvrs_idc.vcx)
*-- ParentClass:  spinner
*-- BaseClass:    spinner
...
**************************************************
*-- Class:        base_spinner_numero (k:\aplvfp\classgen\vcxs\admvrs_idc.vcx)
*-- ParentClass:  spinner
*-- BaseClass:    spinner
...
**************************************************
*-- Class:        base_textbox (k:\aplvfp\classgen\vcxs\admvrs_idc.vcx)
*-- ParentClass:  textbox
*-- BaseClass:    textbox
...
**************************************************
*-- Class:        base_textbox_cmdhelp (k:\aplvfp\classgen\vcxs\admvrs_idc.vcx)
*-- ParentClass:  container
*-- BaseClass:    container
*-- Time Stamp:   09/03/09 04:34:13 PM
*
...
**************************************************
*-- Class:        base_textbox_cmdhelp_contenedor (k:\aplvfp\classgen\vcxs\admvrs_idc.vcx)
*-- ParentClass:  base_container (k:\aplvfp\classgen\vcxs\admvrs.vcx)
*-- BaseClass:    container
...
**************************************************
*-- Class:        base_textbox_fecha (k:\aplvfp\classgen\vcxs\admvrs_idc.vcx)
...
**************************************************
*-- Class:        base_textbox_ip (k:\aplvfp\classgen\vcxs\admvrs_idc.vcx)
*-- ParentClass:  base_textbox (k:\aplvfp\classgen\vcxs\admvrs.vcx)
*-- BaseClass:    textbox
...
**************************************************
*-- Class:        base_textbox_label (k:\aplvfp\classgen\vcxs\admvrs_idc.vcx)
*-- ParentClass:  base_textbox (k:\aplvfp\classgen\vcxs\admvrs.vcx)
*-- BaseClass:    textbox
...
**************************************************
*-- Class:        base_textbox_moneda (k:\aplvfp\classgen\vcxs\admvrs_idc.vcx)
*-- ParentClass:  base_textbox (k:\aplvfp\classgen\vcxs\admvrs.vcx)
*-- BaseClass:    textbox
...
**************************************************
*-- Class:        base_textbox_numero (k:\aplvfp\classgen\vcxs\admvrs_idc.vcx)
*-- ParentClass:  base_textbox (k:\aplvfp\classgen\vcxs\admvrs.vcx)
*-- BaseClass:    textbox
...
**************************************************
*-- Class:        base_textbox_serie (k:\aplvfp\classgen\vcxs\admvrs_idc.vcx)
...
**************************************************
*-- Class:        base_textbox_texto (k:\aplvfp\classgen\vcxs\admvrs_idc.vcx)
*-- ParentClass:  base_textbox (k:\aplvfp\classgen\vcxs\admvrs.vcx)
*-- BaseClass:    textbox
...
**************************************************
*-- Class:        cmd_base (k:\aplvfp\classgen\vcxs\admvrs_idc.vcx)
*-- ParentClass:  base_command (k:\aplvfp\classgen\vcxs\admvrs.vcx)
*-- BaseClass:    commandbutton
...
**************************************************
*-- Class:        cmdbase (k:\aplvfp\classgen\vcxs\admvrs_idc.vcx)
*-- ParentClass:  base_command (k:\aplvfp\classgen\vcxs\admvrs.vcx)
*-- BaseClass:    commandbutton
...
**************************************************
*-- Class:        cnt_cab_almacen (k:\aplvfp\classgen\vcxs\admvrs_idc.vcx)
*-- ParentClass:  base_container (k:\aplvfp\classgen\vcxs\admvrs.vcx)
*-- BaseClass:    container
...
**************************************************
*-- Class:        cnt_cab_ventas (k:\aplvfp\classgen\vcxs\admvrs_idc.vcx)
*-- ParentClass:  base_container (k:\aplvfp\classgen\vcxs\admvrs.vcx)
*-- BaseClass:    container
*-- Time Stamp:   11/26/10 02:32:03 PM
*
		...
		*!*	GoGfgVta.XsCodRef=this.Value
		...
		DO CASE
			...
			CASE this.Parent.Parent.ObjRefTran.XnTpoFac = 2
				this.Parent.Parent.pgfDetalle.page1.LblGuias.Caption =    'Pedido(s)'
...
**************************************************
*-- Class:        cntcodcta (k:\aplvfp\classgen\vcxs\admvrs_idc.vcx)
...
**************************************************
*-- Class:        cntdoc_ref (k:\aplvfp\classgen\vcxs\admvrs_idc.vcx)
*-- ParentClass:  base_container (k:\aplvfp\classgen\vcxs\admvrs.vcx)
*-- BaseClass:    container
...
**************************************************
*-- Class:        cntlookup (k:\aplvfp\classgen\vcxs\admvrs_idc.vcx)
*-- ParentClass:  container
*-- BaseClass:    container
...
**************************************************
*-- Class:        cntnotaseeff (k:\aplvfp\classgen\vcxs\admvrs_idc.vcx)
*-- ParentClass:  base_container (k:\aplvfp\classgen\vcxs\admvrs.vcx)
*-- BaseClass:    container
*-- Time Stamp:   12/07/09 12:22:02 PM
*
#INCLUDE "k:\aplvfp\bsinfo\progs\const.h"
*
...
**************************************************
*-- Class:        cntpage_almacen (k:\aplvfp\classgen\vcxs\admvrs_idc.vcx)
*-- ParentClass:  base_container (k:\aplvfp\classgen\vcxs\admvrs.vcx)
*-- BaseClass:    container
...
**************************************************
*-- Class:        cntpage_ventas (k:\aplvfp\classgen\vcxs\admvrs_idc.vcx)
*-- ParentClass:  base_container (k:\aplvfp\classgen\vcxs\admvrs.vcx)
*-- BaseClass:    container
*-- Time Stamp:   12/01/10 11:36:04 AM
*
#INCLUDE "k:\aplvfp\bsinfo\progs\const.h"
*
...
**************************************************
*-- Class:        cntpage_ventas_coti (k:\aplvfp\classgen\vcxs\admvrs_idc.vcx)
*-- ParentClass:  base_container (k:\aplvfp\classgen\vcxs\admvrs.vcx)
*-- BaseClass:    container
*-- Time Stamp:   12/01/10 11:36:09 AM
*
