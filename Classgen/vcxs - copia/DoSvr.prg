...
*-- ParentClass:  custom
*-- BaseClass:    custom
*-- Time Stamp:   11/26/10 02:53:02 PM
*
#INCLUDE "k:\aplvfp\bsinfo\progs\const.h"
*
		...
		SCAN WHILE EVAL(PsCamposPK) = PsValorPK FOR &LsFor.
			...
			DO CASE 
				CASE PsAlias = 'RPED'
					...
					ENDIF
					IF VARTYPE(NroDoc) = 'C' AND  INLIST(THIS.XsCodDoc , 'PROF','PEDI','COTI')
						REPLACE NroDoc	 WITH THIS.XsNroDoc
					ENDIF
					IF VARTYPE(CodDoc) = 'C' AND  INLIST(THIS.XsCodDoc , 'PROF','PEDI','COTI')
						REPLACE CodDoc	 WITH THIS.XsCodDoc
					ENDIF
					...
					ENDIF
					IF VARTYPE(UndStk) = 'C' AND VARTYPE(UndVta)='C' AND VARTYPE(Factor)='N'
