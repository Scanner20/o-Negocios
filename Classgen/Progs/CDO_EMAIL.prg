TRY
  ...
  WITH loConfig.FIELDS
    ...
    .ITEM(lcSchema + "sendusername") = "victortorrestejada@gmail.com"
    .ITEM(lcSchema + "sendpassword") = "vt2005"
    .UPDATE
  ENDWITH
  ...
  WITH loMsg
    ...
    .FROM = "vtorres@o-negocios.com"
    .TO = "vettbs@hotmail.com"
    .Subject = "Prueba desde Gmail - 2"
