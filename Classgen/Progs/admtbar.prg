...
**************************************************
*-- Class:        base_checkbox_serie (k:\aplvfp\classgen\vcxs\admtbar.vcx)
*-- ParentClass:  checkbox
*-- BaseClass:    checkbox
*-- Time Stamp:   12/04/06 12:59:06 PM
*
...
*-- Time Stamp:   09/26/07 03:16:01 PM
*
...
*-- ParentClass:  cmd_base (k:\aplvfp\classgen\vcxs\admvrs.vcx)
*-- BaseClass:    commandbutton
*-- Time Stamp:   09/25/10 10:53:09 AM
*
DEFINE CLASS cmdaceptar AS cmd_base


	WordWrap = .F.
	Picture = "..\..\grafgen\iconos\button_ok_16.ico"
	SpecialEffect = 0
	PicturePosition = 14
	Themes = .T.
	Name = "cmdaceptar"
...
*-- ParentClass:  cmd_base (k:\aplvfp\classgen\vcxs\admvrs.vcx)
*-- BaseClass:    commandbutton
*-- Time Stamp:   09/25/10 10:56:13 AM
*
DEFINE CLASS cmdanalisis AS cmd_base


	Picture = "..\..\grafgen\iconos\analisis.bmp"
	DisabledPicture = "..\..\grafgen\iconos\analisis_disable.bmp"
