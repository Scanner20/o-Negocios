...
CASE Quiebre1='C'
	...
	**LnLenAct=IIF(LEN(TRIM(DesAct))>0,LEN(TRIM(DesAct)),2)
	...
	IF CostoAc>0
		replace col05 wITH PADL(TRANSFORM(CostoAC,'999,999.99'),10)
	ENDIF
...
CASE Quiebre1='D'
	...
	replace col04 WITH []
	replace col05 wITH PADL(TRANSFORM(CostoMo,'999,999.99'),10)
...
CASE Quiebre1='E'
	...
	replace col05 WITH PADL(TRANSFORM(CostoMt,'999,999.99'),10)
...
CASE oRegLin.Quiebre1='DT'
	...
	REPLACE col03 WITH REPLICATE(".",LEN(COL03))
	REPLACE col04 WITH REPLICATE(".",LEN(COL04))
	REPLACE col05 WITH REPLICATE(".",LEN(COL05)-5)
	APPEND BLANK 	
	GATHER NAME oRegLin
	REPLACE Col03 WITH "Total Mano de Obra -->" 
	REPLACE col05 WITH PADL(TRANSFORM(oRegLin.CostoMO,'999,999.99'),10)
	APPEND BLANK 
	GATHER NAME oRegLin
	REPLACE col01 WITH REPLICATE("-",LEN(COL01))
	REPLACE col02 WITH REPLICATE("-",LEN(COL02))
...
CASE oRegLin.Quiebre1='ET'
	...
	REPLACE col05 WITH PADL(TRANSFORM(oRegLin.CostoMt,'999,999.99'),10)
	APPEND BLANK 
	GATHER NAME oRegLin
	REPLACE col01 WITH REPLICATE("-",LEN(COL01))
	REPLACE col02 WITH REPLICATE("-",LEN(COL02))
