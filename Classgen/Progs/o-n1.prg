**************************************************
*-- Class Library:  k:\aplvfp\classgen\vcxs\o-n1.vcx
**************************************************


**************************************************
*-- Class:        acabecera (k:\aplvfp\classgen\vcxs\o-n1.vcx)
*-- ParentClass:  custom
*-- BaseClass:    custom
...
**************************************************
*-- Class:        adetalle (k:\aplvfp\classgen\vcxs\o-n1.vcx)
*-- ParentClass:  custom
*-- BaseClass:    custom
...
**************************************************
*-- Class:        base_transac (k:\aplvfp\classgen\vcxs\o-n1.vcx)
...
**************************************************
*-- Class:        calculo_credito (k:\aplvfp\classgen\vcxs\o-n1.vcx)
*-- ParentClass:  custom
*-- BaseClass:    custom
...
**************************************************
*-- Class:        cntdetalle_detalle_detalle (k:\aplvfp\classgen\vcxs\o-n1.vcx)
...
**************************************************
*-- Class:        precio_venta (k:\aplvfp\classgen\vcxs\o-n1.vcx)
*-- ParentClass:  custom
*-- BaseClass:    custom
...
**************************************************
*-- Class:        ui (k:\aplvfp\classgen\vcxs\o-n1.vcx)
*-- ParentClass:  custom
*-- BaseClass:    custom
